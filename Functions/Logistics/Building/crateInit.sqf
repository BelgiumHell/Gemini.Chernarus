...
[[_crate],{
    _action = ["placeWall", "Concrete wall", "", {["Land_CncWall4_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;

    _action = ["placeHB", "H-barrier", "", {["Land_HBarrierWall4_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;

    _action = ["placeSandbag", "Sandbag", "", {["Land_BagFence_Long_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;

    _action = ["placeRazorwire", "Razorwire", "", {["Land_Razorwire_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;

    _action = ["placeTowerH", "Bunker", "", {["Land_HBarrierTower_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;

    _action = ["placeTower", "Watchtower", "", {["Land_Cargo_Patrol_V1_F"]spawn JOC_buildPlaceObject}, {((vehicleVarName (_this select 1)) in logisticsArray) && (alive (_this select 0))}] call ace_interact_menu_fnc_createAction;
    [_crate, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;
