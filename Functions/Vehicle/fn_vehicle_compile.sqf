...
JOC_garageGetArray = compileFinal preprocessFileLineNumbers "Functions\Vehicle\Garage\getArray.sqf";

//Tow
JOC_tow = compileFinal preprocessFileLineNumbers "Functions\Vehicle\Tow\tow.sqf";
