...
if (typeName _skill == "STRING") exitWith {
    switch (toLower _skill) do {
        ...
        case "infantry": {
                0 = [_setSkillUnits, [[0.19, 0.21], [0.03, 0.04], [0.25, 0.3], 1, [0.4, 0.5], [0.5, 0.7], [0.7, 0.8], [0.6, 0.8], [0.7, 0.8], [0.3, 0.4]]] call Zen_SetAISkill;
        };
        case "sniper": {
                0 = [_setSkillUnits, [0.9, [0.5, 0.6], [0.1, 0.2], 1, [0.8, 0.9], [0.8, 1], 0.9, [0.8, 0.1], 1, 1]] call Zen_SetAISkill;
        };
        case "sof": {
                0 = [_setSkillUnits, [[0.5, 0.6], [0.1, 0.12], [0.35, 0.4], 1, 1, 1, 1, 1, [0.8, 0.9], [0.5, 0.6]]] call Zen_SetAISkill;
        };
        case "officer": {
